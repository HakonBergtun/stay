...
const hotels = [
    { id: 1, name: "Hotel Oslo", stars: "4",location: "Oslo", price: 1200, rooms: "double bed", modern: false, view: "golfbane", image: "./assets/images/hoteloslo.jpeg", available: true, facilities: ["Gratis Wi-Fi", "Frokost", "Gym"], Description: "Grand Hotel Oslo er et ikonisk hotell som ligger i hjertet av Oslo, på den berømte Karl Johans gate. Hotellet tilbyr elegante rom med klassisk innredning og moderne fasiliteter, inkludert gratis Wi-Fi, frokost og et treningsrom. Med sin sentrale beliggenhet og historiske sjarm, er Grand Hotel Oslo et ideelt valg for både forretningsreisende og turister som ønsker å oppleve det beste av Oslo." },
    { id: 2, name: "Bergen Opera Hotel", stars: "5", location: "Bergen", price: 2380, rooms: "single bed", modern: false, image: "./assets/images/hotelbergen.jpeg", view: "utsikt over havet", available: true, facilities: ["Spa", "Badebasseng", "Restaurant"], Description: "Thon Hotel Opera er et moderne hotell som ligger i det pulserende området Bjørvika, bare en kort spasertur fra Oslo sentrum. Hotellet tilbyr komfortable rom med moderne fasiliteter, inkludert gratis Wi-Fi, spa, pool og en restaurant som serverer deilige retter. Med sin sentrale beliggenhet og flotte fasiliteter, er Thon Hotel Opera et ideelt valg for både forretningsreisende og turister som ønsker å utforske Oslo." },
    { id: 3, name: "Hotel Trondheim Sjøsiden", stars: "4", location: "Trondheim", price: 940, rooms: "suite", modern: true, image: "../assets/images/hoteltrondheim.jpeg", view: "utsikt fjorden", available: true, facilities: ["Gratis Wi-Fi", "Frokost", "Gym"], Description: "Budget Inn Grunderløkka er et budsjettvennlig hotell som tilbyr komfortable rom og en sentral beliggenhet i det trendy området Grunerløkka. Hotellet har moderne fasiliteter, inkludert gratis Wi-Fi, et felles kjøkken og vaskeri, samt et treningsrom for gjestene. Med sin unike kombinasjon av rimelige priser og praktiske fasiliteter, er Budget Inn Grunderløkka et ideelt valg for reisende som ønsker å utforske Oslo uten å sprenge budsjettet." }
];
