...
function saveHotel(hotel) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const modernInput = document.getElementById('input-modern');
        const availableInput = document.getElementById('input-available');
        const updatedFields = {
        ...
        const response = yield fetch(`http://localhost:4000/api/hotels/${hotel.id}`, {
            method: "PUT",
...
function renderDetails(hotel) {
    ...
    if (isEditing) {
        ...
        (_a = document.getElementById('save-btn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => saveHotel(hotel));
        (_b = document.getElementById('cancel-btn')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
            isEditing = false;
            renderDetails(hotel);
        });
    }
...
function renderFacilities(hotel) {
...
function loadHotel() {
    ...
    `;
        ...
        (_b = document.getElementById('submit-review-btn')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
            postReview(hotel.id);
        });
        (_c = document.getElementById('book-btn')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => {
